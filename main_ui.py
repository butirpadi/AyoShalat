...
"}")
        ...
        self.ckStartTray.setGeometry(QRect(20, 260, 101, 25))
...
"}")
        ...
        self.label_5 = QLabel(self.containerSetting)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(20, 210, 251, 25))
        self.txBeforeTime = QLineEdit(self.containerSetting)
        self.txBeforeTime.setObjectName(u"txBeforeTime")
        self.txBeforeTime.setGeometry(QRect(20, 230, 61, 25))
        self.label_7 = QLabel(self.containerSetting)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(90, 230, 54, 21))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Notification before pray time", None))
